        ...
        return (
          ...
          >
            <div className="bg-gradient-to-r from-[#eff4ff] to-[#dce9ff] px-4 py-3">
              <p className="font-extrabold !text-[#111827]">{category}</p>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[760px] text-sm">
                <thead className="bg-[#f1f5f9] text-left">
                  <tr>
                    <th className="px-4 py-3 font-extrabold !text-[#26364d]">Verificación</th>

                    <th className="w-44 px-4 py-3 font-extrabold !text-[#26364d]">Estado</th>
